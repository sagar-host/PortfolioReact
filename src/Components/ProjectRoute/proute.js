...
<li><a href="https://github.com/sagar-host/SHOPIE-FRONTEND">Code   <i className="fa fa-github"></i></a></li>
<li><a href="https://www.mytextui.com/">Live      <i className="fa fa-chevron-circle-up "></i></a></li>
...
<Card.Text>
MERN  Admin PANEL CRUD <br /> with Web API and Registration  only for admin .
</Card.Text>
<div className="picons">
<ul className="psocials">
